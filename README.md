...
- **Responsive Sidebar Navigation**: Clean and collapsible sidebar for easy navigation.
- **Real-time Data Visualization (Mock Data)**: Interactive charts powered by Recharts.
- **Transaction History Tables**: Sortable and clear transaction records.
